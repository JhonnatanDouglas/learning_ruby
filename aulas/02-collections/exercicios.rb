...
numbers_hash.each do |_key, value|
  value_now = value if value > value_now
end

numbers_hash.select do |key, value|
  puts "O Hash de valor mais alto é de chave #{key} e o valor de #{value}." if value_now == value
end
